...
const GeneradorExcel = (() => {
  ...
  async function generarReporteCompleto(resultado, opciones, nombreOriginal, ExcelLibIn) {
    ...
    if (!ExcelLib) throw new Error("La librer├¡a ExcelJS no est├í disponible.");
    ...
    infoLbl.value = "INFORMACI├ôN DEL DOCUMENTO";
    ...
    try {
      ...
      console.warn("No se pudieron generar las im├ígenes de las gr├íficas:", e);
    }
